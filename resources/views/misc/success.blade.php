...
<a href={{ route('home') }} class="bg-blue-500 hover:bg-blue-600 text-sm font-bold uppercase text-white font-primary py-3 px-5 rounded transition duration-300">Retour à la page d'accueil</a>
</div>
</body>
</html>